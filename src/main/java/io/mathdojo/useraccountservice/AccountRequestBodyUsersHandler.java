...
public class AccountRequestBodyUsersHandler
    ...
    public HttpResponseMessage executePostForNewUserInOrg(@HttpTrigger(name = "request", methods = {
        ...
        try {
            ...
            AccountModificationRequest modificationRequest = new AccountModificationRequest(requestBody.getAccountId(),
                    orgId, requestBody.isAccountVerified(), requestBody.getName(), requestBody.getProfileImageLink());
